...
class EspIdfStabilityRegressionTests(unittest.TestCase):
    ...
    def test_juniper_hw4_catalog_uses_existing_plugins_and_installs_disabled(self) -> None:
        ...
        self.assertIn("kSentinelReleaseChannelPublished = false", self.dashboard)
        self.assertIn("Sentinel release channel is not published", self.dashboard)
        self.assertIn("Sentinel 릴리스 채널 준비 중", self.ui)
